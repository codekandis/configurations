...
namespace CodeKandis\Configurations\Tests\DataProviders\PlainConfigurationNotFoundExceptionInterfaceTest;
...
class ThrowableClassNamesWithNonExistentConfigurationPathExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				'throwableClassName'           => $throwableClassName = PlainConfigurationNotFoundException::class,
				...
				'expectedThrowableMessage'     => sprintf( PlainConfigurationNotFoundException::EXCEPTION_MESSAGE_PLAIN_CONFIGURATION_NOT_FOUND, $nonExistentConfigurationPath )
			]
		];
	}
}
