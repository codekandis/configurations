...
{
	/**
	 * Tests if the method `ConfigurationInterface::read()` throws a `CodeKandis\Configurations\PlainConfigurationIndexNotFoundExceptionInterface` on a nonexistent index.
	...
	public function testIfMethodReadThrowsPlainConfigurationIndexNotFoundExceptionInterfaceOnInvalidValueType( ConfigurationInterface $configuration, array $nonExistentIndices, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		...
		{
			static::assertInstanceOf( PlainConfigurationIndexNotFoundExceptionInterface::class, $throwable );
